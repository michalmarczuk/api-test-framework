...
export default class Endpoint {
    ...
    static validatePostResponse(responseData) {
        return this.validator.validate(responseData, this.responseSchemas().postSchema);
    }
    ...
    async postRawData(data) {
        return await this.axiosInstance.post(this.resource, data);
    }
}
